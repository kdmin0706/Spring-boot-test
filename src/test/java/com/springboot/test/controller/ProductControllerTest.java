...
class ProductControllerTest {
    ...
    void createProductTest() throws Exception {
        //Mock 객체에서 특정 메서드를 실행하는 경우 실제 Return을 줄 수 없기 때문에 아래와 같이 가정 사항을 만들어준다.
        given(this.productService.saveProduct(new ProductDto("pen", 5000, 2000)))
        ...
        verify(this.productService)
                .saveProduct(new ProductDto("pen", 5000, 2000));
    }
}